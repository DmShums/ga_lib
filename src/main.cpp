...
int main(){
    ...
    SetUp setUp;
    setUp.generationsNum = 50;
    setUp.crossoverPairsNum = 20;
    setUp.mutationNum = 20;

    Solver solver(setUp);

    SalesmanPopulation population(distance_matrix, 50);
    Individual solution = solver.solve(population);

    std::cout << "distance: " << solution.fitness << std::endl << "path: " << std::endl;
